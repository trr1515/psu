...
This script takes a statewide US Fish and Wildlife National Wetlands Inventory
dataset and breaks it down based on the type of wetland, rasterizes, 
and reclassifies into a single raster.
'''
...
#If you get None it means there is an incorrect driver code. The object type should be returned.
if ds is None:
    print "Open failed./n"
    sys.exit(1)

folder = r'C:\FinalCapstone\Wetlands'
...
#Script to use proximity analysis and compute mean distance from roads.
folder = r'C:\FinalCapstone\Wetlands'
# Set the cell size for the analysis.
cellsize = 10
...
for wl in wetlandTypeList:
    ...
    #Use the temporary raster to set the proximity to 1 and NoData outside study area
    ...
    os.chdir(r'C:\FinalCapstone\Wetlands')
